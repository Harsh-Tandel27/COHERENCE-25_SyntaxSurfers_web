    ...
    <div className="flex min-h-screen flex-col">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Real-time insights into your city's vital systems. Monitor
                    air quality, traffic conditions, water levels, and energy
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Real-time data from sensors across the city, providing
                  insights into urban conditions.
                </p>
              </div>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our comprehensive suite of tools helps city managers make
              ...
              {[
                {
                  ...
                  description:
                    "Get instant updates on all city systems with our real-time monitoring dashboard.",
                  icon: BarChart3,
                },
                {
                  title: "Smart Alerts",
                  description:
                    "Receive notifications when metrics exceed normal thresholds or require attention.",
                  icon: ShieldAlert,
                },
                {
                  title: "Data Analytics",
                  description:
                    "Analyze historical data to identify patterns and make informed decisions.",
                  icon: BarChart3,
                },
                {
                  title: "Mobile Access",
                  description:
                    "Access your dashboard from anywhere with our mobile-responsive platform.",
                  icon: User,
                },
                {
                  title: "Community Engagement",
                  description:
                    "Enable citizen reporting and feedback to improve city services.",
                  icon: MessageSquare,
                },
                {
                  title: "Custom Reports",
                  description:
                    "Generate detailed reports for stakeholders and city officials.",
                  icon: BarChart3,
                },
              ].map((feature, index) => (
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Join hundreds of cities worldwide using our platform to
      ...
      <footer className="w-full border-t bg-background py-6 md:py-8">
        <div className="container flex flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <div className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} SmartCity Technologies. All rights
            reserved.
          </div>
        </div>
      </footer>
